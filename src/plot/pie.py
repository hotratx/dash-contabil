...
def pie_new(df: pd.DataFrame, year):
    ...
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[0]["desp_operacionnal"], df.iloc[0]["rec_bruta_ope"]], name="1 tri"),
                  1, 1)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[1]["desp_operacionnal"], df.iloc[1]["rec_bruta_ope"]], name="2 tri"),
                  1, 2)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[2]["desp_operacionnal"], df.iloc[2]["rec_bruta_ope"]], name="3 tri"),
                  1, 3)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[3]["desp_operacionnal"], df.iloc[3]["rec_bruta_ope"]], name="4 tri"),
                  1, 4)
...
def pie_impostos(df: pd.DataFrame, year):
    ...
    fig = make_subplots(rows=1, cols=4, specs=[[{'type': 'domain'}, {'type': 'domain'}, {'type': 'domain'}, {'type': 'domain'}]])
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[0]["icms"], df.iloc[0]["cofins"], df.iloc[0]["pis"], df.iloc[0]["contri_social_sobre_lucro"]], name="1 tri"),
                  1, 1)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[1]["icms"], df.iloc[1]["cofins"], df.iloc[1]["pis"], df.iloc[1]["contri_social_sobre_lucro"]], name="2 tri"),
                  1, 2)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[2]["icms"], df.iloc[2]["cofins"], df.iloc[2]["pis"], df.iloc[2]["contri_social_sobre_lucro"]], name="3 tri"),
                  1, 3)
    fig.add_trace(go.Pie(labels=labels, values=[df.iloc[3]["icms"], df.iloc[3]["cofins"], df.iloc[3]["pis"], df.iloc[3]["contri_social_sobre_lucro"]], name="4 tri"),
                  1, 4)
